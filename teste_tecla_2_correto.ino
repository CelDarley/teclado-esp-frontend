// Teste da tecla 2 com pinos corretos
// Pinos do ESP32: 25 e 26
// Pinos do teclado: 1 e 6

const int PIN_LINHA = 25;   // Pino 25 do ESP32 (conectado ao pino 1 do teclado)
const int PIN_COLUNA = 26;  // Pino 26 do ESP32 (conectado ao pino 6 do teclado)

void setup() {
  Serial.begin(115200);
  delay(2000);
  
  Serial.println("\n\n=== TESTE TECLA 2 COM PINOS CORRETOS ===");
  Serial.println("Conexões:");
  Serial.println("Pino 1 do teclado -> Pino 25 do ESP32");
  Serial.println("Pino 6 do teclado -> Pino 26 do ESP32");
