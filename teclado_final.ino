...
// Layout do teclado (baseado no seu mapeamento completo)
char keys[ROWS][COLS] = {
...
// Pinos conectados às linhas e colunas (baseado no seu teste)
byte rowPins[ROWS] = {1, 2, 3, 4};  // Linhas
byte colPins[COLS] = {5, 6, 7};      // Colunas
...
void setup() {
  ...
  Serial.println("\n\n=== TECLADO FINAL FUNCIONANDO ===");
  Serial.println("Mapeamento completo confirmado:");
  Serial.println("Linha 1 (Pino 1): 1, 2, 3");
  Serial.println("Linha 2 (Pino 2): 4, 5, 6");
  Serial.println("Linha 3 (Pino 3): 7, 8, 9");
  Serial.println("Linha 4 (Pino 4): *, 0, #");
  Serial.println();
