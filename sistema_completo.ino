...
const char* serverUrl = "http://192.168.1.100:8000";  // Ajuste para o IP do seu backend
const char* apiEndpoint = "/api/access/verify/";
...
const int RELAY_PIN = 22;    // Relé da fechadura
