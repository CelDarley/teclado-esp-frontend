    ...
    // Pinos do ESP32 (baseado no seu mapeamento)
    byte rowPins[ROWS] = {25, 26, 27, 14};  // Linhas do ESP32
    byte colPins[COLS] = {12, 13, 15};       // Colunas do ESP32
    ...
    Serial.println("\n\n=== TECLADO COMPLETO CORRETO ===");
    Serial.println("Mapeamento dos pinos:");
    Serial.println("Teclado -> ESP32");
    Serial.println("Pino 1 -> Pino 25 (Linha 1)");
    Serial.println("Pino 2 -> Pino 26 (Linha 2)");
    Serial.println("Pino 3 -> Pino 27 (Linha 3)");
    Serial.println("Pino 4 -> Pino 14 (Linha 4)");
    Serial.println("Pino 5 -> Pino 12 (Coluna 1)");
    Serial.println("Pino 6 -> Pino 13 (Coluna 2)");
    Serial.println("Pino 7 -> Pino 15 (Coluna 3)");
    Serial.println();
